...
parser.add_argument('--data-path', type=str, default='/scratch/zc807/nlu/tur_sentence_reconstruction', metavar='PATH',
                    help='data path of pairs.pkl and lang.pkl (default: /scratch/zc807/nlu/tur_sentence_reconstruction)')
parser.add_argument('--save-data-path', type=str, default='/scratch/zc807/nlu/tur_embedding_weights', metavar='PATH',
                    help='data path to save embedding_weights.pkl (default: /scratch/zc807/nlu/tur_embedding_weights)')
