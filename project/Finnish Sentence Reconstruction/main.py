...
parser.add_argument('--data-path', type=str, default='/scratch/zc807/nlu/finnish_sentence_reconstruction', metavar='PATH',
                    help='data path of pairs.pkl and lang.pkl (default: /scratch/zc807/nlu/finnish_sentence_reconstruction)')
parser.add_argument('--save-data-path', type=str, default='/scratch/zc807/nlu/finnish_embedding_weights', metavar='PATH',
                    help='data path to save embedding_weights.pkl (default: /scratch/zc807/nlu/finnish_embedding_weights)')
...
if __name__ == '__main__':
    ...
    print("Untrimmed N-gram Vocab Size:", len(lang.vocab_ngrams))
