...
parser.add_argument('--save-data-path', type=str, default='/scratch/zc807/nlu/finnish_sentence_reconstruction', metavar='PATH',
                    help='data path to save pairs.pkl and lang.pkl (default: /scratch/zc807/nlu/finnish_sentence_reconstruction)')
...
if __name__ == '__main__':
    ...
    input_lang, output_lang, train_pairs, test_pairs = prepareData('fin', 'fin', 
