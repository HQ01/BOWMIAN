...
parser.add_argument('--data-path', type=str, default='/scratch/zc807/nlu/fin_word_order', metavar='PATH',
                    help='data path of pairs.pkl and lang.pkl (default: /scratch/zc807/nlu/fin_word_order)')
...
if __name__ == '__main__':
    ...
    if not args.hpc:
        args.data_path = '.'
        args.load_data_path = '../finnish_embedding_weights'
