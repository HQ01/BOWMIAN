...
parser.add_argument('--data-path', type=str, default='/scratch/zc807/nlu/fin_order', metavar='PATH',
                    help='data path of pairs.pkl and lang.pkl (default: /scratch/zc807/nlu/fin_order)')
