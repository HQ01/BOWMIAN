...
parser.add_argument('--save-data-path', type=str, default='/scratch/zc807/nlu/fin_sentence_length', metavar='PATH',
                    help='data path to save pairs.pkl and lang.pkl (default: /scratch/zc807/nlu/fin_sentence_length)')
