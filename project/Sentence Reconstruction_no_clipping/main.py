...
parser.add_argument('--save-data-path', type=str, default='/scratch/zc807/nlu/sentence_reconstruction', metavar='PATH',
                    help='data path to save embedding_weights.pkl (default: /scratch/zc807/nlu/sentence_reconstruction)')
...
if __name__ == '__main__':
    ...
    with open(args.save_data_path + "/embedding_weights%d_no_clipping.pkl" % args.order, 'wb') as f:
