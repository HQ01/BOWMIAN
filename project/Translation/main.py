...
parser = argparse.ArgumentParser(description='Translation with NGrams')
...
def variablesFromPair(pair, input_lang, output_lang, args):
    input_variable = variableFromNGramList(input_lang.vocab_ngrams, pair[0], args.num_words, args)
